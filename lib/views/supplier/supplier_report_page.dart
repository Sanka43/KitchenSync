...
class _SupplierReportPageState extends State<SupplierReportPage> {
  ...
  Future<void> _loadReport() async {
    ...
    try {
      ...
      print('Error loading supplier report: $e');
    }
  ...
  Future<void> _generateAndDownloadPdf() async {
    ...
    pdf.addPage(
      pw.MultiPage(
        build: (context) => [
          pw.Text(
            '${widget.shopName} - ${selectedMode.toUpperCase()} REPORT',
    ...
    await Printing.layoutPdf(
      ...
      name: '${widget.shopName}_${selectedMode.toLowerCase()}_report.pdf',
    );
  }
